...
import { CircleSlash, Music, Volume2, VolumeX } from 'lucide-react'
...
export default function PublicLeadFormPage() {
  ...
  return (
    <div className="min-h-[calc(100vh-0px)] bg-[var(--ds-bg-base)] px-3 py-6 text-[var(--ds-text-primary)] sm:px-4 sm:py-10 relative">
      {/* Background Audio */}
